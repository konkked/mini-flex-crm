...
/** 
 * 📌 DYNAMIC API BUILDER 
 * - Generates API endpoints dynamically based on entity names.
 * - Provides standard CRUD functions (list, get, edit, create, delete).
 * - Supports optional pagination (nextToken for listing).
 */
